...
function loadStatsPage(){
	...
	for (i = 2; i < document.getElementById("stats_table").rows.length; i++){
		...
		awayScore = parseInt(document.getElementById("stats_table").rows[i].cells[3].innerHTML);
...
function loadPlayersPage(){
	...
	for(i = 0; i < 4; i++){
		dropDownT += '<a class = "dropdown-item" href = # onclick = "switchPlayers('+ i +')">' + players[i].name + '</a>';
	}
	document.getElementById("player_selector").innerHTML = dropDownT;
...
function switchPlayers(playerNum){
	...
	var avgPassingYards = player.pass_yards/player.games_played;
	var avgRushingYards = player.rushing_yards/player.games_played;
	var avgRecgYards = player.receiving_yards/player.games_played;
	...
	document.getElementById("avg_rec_yards").innerHTML = avgRecgYards;
}
